...
capture stcox 	i.hiv i.ethnicity age1 age2 age3 i.male i.imd i.smoke_nomiss i.obese4cat , strata(stp)
if _rc==0 {
...
capture stcox 	i.hiv age1 age2 age3 i.male i.imd i.smoke_nomiss i.obese4cat , strata(stp)
if _rc==0 {
